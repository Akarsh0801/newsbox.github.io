...
export default function Navbar(){
    ...
    return(
            <div className='nav flex justify-between items-center bg-black text-white h-fit w-full p-3 '>
              <h1 className='text-2xl font-semibold text-center mx-auto'>NewsBox</h1>     
              <div>
